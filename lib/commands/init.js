...
import { configureMcps, installSkills, installGsd, installCcDeploy, cleanupSkillsStructure } from '../core/ecosystem-installer.js';
...
export async function initCommand(projectName, options = {}) {
  try {
    ...
    printStep(6, TOTAL_STEPS, 'Installing find-skills...');
