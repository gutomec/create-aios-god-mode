...
const SQUAD_CHOICES = [
  ...
  { title: 'BrandCraft \u2014 Brand design', value: 'brandcraft', selected: false },
 ...
 * @returns {Promise<{ name: string, projectType: string, language: string, squads: string[] }>}
 */
 ...
 * @returns {{ name: string, projectType: string, language: string, squads: string[] }}
 */
